      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mt-16">
            <div className="inline-flex items-center space-x-4 bg-gradient-eco text-white rounded-2xl px-8 py-6 shadow-xl">
              <div className="text-3xl">🌱✨</div>
              <div>
                <div className="font-semibold">Ready to make an impact? 🚀</div>
                <div className="text-sm opacity-90">Join 12,000+ eco-warriors today 👗🌍♻️</div>
              </div>
              <div className="text-3xl">🎯💚</div>
            </div>
          </div>
